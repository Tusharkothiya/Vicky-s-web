  ...
  const faqs = [
    {
      ...
      answer:
        "This includes budgeting for talent acquisition, managing payroll and benefits, financial reporting on HR activities",
    },
    {
      question: "How is this different from generic bootcamps?",
      answer:
    ...
    {
      question: "Can you actually help me get placed?",
      answer:
