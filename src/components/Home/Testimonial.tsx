          ...
          <div className="order-2 lg:order-1 h-full ">
            <div className="bg-[#ECE8E0] h-full flex items-start justify-center flex-col p-8 lg:p-10 shadow-lg">
              ...
              <blockquote className="text-gray-800 text-lg lg:text-xl leading-relaxed mb-8">
                "The tailored mock interviews and project feedback helped me
                refine my strengths and confidently showcase them. I landed a
                role as a Full-Stack Developer within weeks"
              </blockquote>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Full-Stack Engineer, TechSphere
                  </p>
                </div>
              </div>
            </div>
