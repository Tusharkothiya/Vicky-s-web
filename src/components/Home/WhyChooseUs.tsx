...
const WhyChooseUs = () => {
  return (
    <section className="bg-[#072E33] relative">
      {/* Overflow wrapper - hides bottom overflow */}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 min-h-screen lg:min-h-[600px]">
            ...
            <div className="relative order-2 lg:order-1 overflow-hidden">
              ...
              <div className="absolute inset-0 lg:-top-16 lg:-bottom-16">
                <img
            ...
            {/* Right Content - Text */}
            <div className="order-1 lg:order-2 flex items-center px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
