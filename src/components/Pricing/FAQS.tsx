...
const FAQS = () => {
  ...
  const faqs = [
    {
      question: "Can I upgrade midway?",
      answer:
        "Absolutely—if you need more coaching or modules, just let us know. You can seamlessly move up to a higher plan during your journey.",
    },
    {
      question: "What if I don’t use all the sessions?",
      answer:
    ...
    {
      question: "Do I get ongoing support after hiring?",
      answer:
            ...
            <div>
              ...
              <div className="space-y-4">
                {faqs.map((faq, index) => (
                  <div
                    key={index}
                    className="bg-[#ECE8E0] rounded-lg border border-gray-200 overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-200"
                  >
                    <button
